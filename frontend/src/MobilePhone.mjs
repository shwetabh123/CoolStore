    ...
    return (
       ...
       <div className='searchbox'>
        ...
        <Box>
            ...
            <Stack text="aa" h={"50vh"} alignItems="normal" flexDirection="row" justifyContent="center" direction={["column", "row"]}>
            <Text>Description:Apple</Text>
            <Card  amount={10} img={"https://m.media-amazon.com/images/I/617FFRO3vcL._SL1500_.jpg"}checkoutHandler={checkoutHandler}/>
            <Text>Description:Apple</Text>
            <Card  amount={30} img={"https://m.media-amazon.com/images/I/617FFRO3vcL._SL1500_.jpg"}checkoutHandler={checkoutHandler}/>
            </Stack>
