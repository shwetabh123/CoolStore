    ...
    return (
       ...
       <div className='searchbox'>
        ...
        <Box>
            ...
            <Card  amount={1} img={"https://m.media-amazon.com/images/I/71L-lTQnJiL._SL1500_.jpg"}checkoutHandler={checkoutHandler}/>
...
export default AppliancesElectronics