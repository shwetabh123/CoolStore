    ...
    return (
        ...
        <div className="preNav" >
             <div className="preNav1">
                 ...
                 {/* <Link className="navlinks" to="/Home" >COOL STORE</Link>
                 */}
            <Link to='/Home'>
            < img id="logoImage1"  width="200" height="80"  justifyContent="center"  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSRPHUmY1bMmNmLFEE8soxrNN59QK6mTQsbHg&usqp=CAU" alt="Not"/>
            </Link>
             </div>
